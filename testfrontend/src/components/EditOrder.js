...
const EditOrder = () => {
    ...
    const [products, setProducts] = useState([
        { id: 1, name: 'Product A', qty: 1, unitPrice: 10, totalPrice: 10 },
        { id: 2, name: 'Product B', qty: 2, unitPrice: 15, totalPrice: 30 },
    ]);
    ...
    return (
        <Container>
            <Typography variant="h4">Edit Order #{id}</Typography>
